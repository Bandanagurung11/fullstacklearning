    ...
    <div className="grid grid-cols-6 gap-12 px-4 pb-16 ">
      <div className="bg-[#3D61FF] shadow-md px-2 py-12 rounded-lg space-y-12 col-span-2">
        <div className="flex gap-2 items-center justify-center">
          ...
          <p className="text-2xl text-white font-bold">Fenzora</p>
        </div>
        <p className="text-md text-white text-center">
          Take your business online with personalized e-commerce solution in
          just 60 seconds , build, customize, sell, and manage all-in-one
          solution.
        </p>
      ...
      <div className="space-y-4 mt-12">
        ...
        {connect.map((each, index) => (
          <div key={index} className="flex items-center hover:text-blue-600  cursor-pointer" >
      ...
      <div className="col-span-2 space-y-8">
        ...
        <p className="text-sm pl-4 opacity-60">The latest features, articles, and resources, sent to your inbox weekly.</p>
        <Input id="name" placeholder="Yourgmail@example.com" />
